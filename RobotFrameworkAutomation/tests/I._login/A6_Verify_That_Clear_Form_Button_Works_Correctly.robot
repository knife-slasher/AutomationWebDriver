*** Settings ***
Documentation     Login: Verify that Clear Form button works correctly.
...
...               This test has a workflow that is created using keywords in
...               the imported resource file.
Suite Setup       Common Browser Navigation    Verify that Clear Form button works correctly.
...
*** Test Cases ***
Verify_That_Clear_Form_Button_Works_Correctly

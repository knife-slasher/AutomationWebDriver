*** Settings ***
Documentation   To test User if it's able to sign up successfully.
...
...
Suite Setup         Common Browser Navigation        To test User if it's able to sign up successfully
